    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            @if (Auth::user()->role == 'Owner')
                ...
                <a href="/laporan" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
                    <i class="fas fa-sticky-note mr-3"></i>
                    Laporan
                </a>
            @endif
            <a href="/data-faqs" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
